  ...
  final List<Cycle> _cycles = [
    Cycle([
      ...
      Session(2, SessionType.push, [
        Exercise.weighted('Bench Press', SetsReps.fixedEndSet(4, 5, 5), Weight(30)),
        Exercise.weighted('Overhead Press', SetsReps.range(3, 8, 12), Weight(15.5)),
        Exercise.weighted('Incline Dumbbell Press', SetsReps.range(3, 8, 12), Weight(15.5)),
        Exercise.weighted('Triceps Pushdowns', SetsReps.range(3, 8, 12), Weight(12.5)),
        Exercise.weighted('Overhead Tri Extends', SetsReps.range(3, 8, 12), Weight(12.5)),
      ]),
    ])
  ];
